# Rule: "Starburst Constraint-Based Predicate Propagation"

**Category:** logical/predicate-pushdown
**File:** `rules/logical/predicate-pushdown/starburst-constraint-propagation.rra`

## Metadata

- **ID:** `starburst-constraint-propagation`
- **Version:** "1.0.0"
...
```yaml
  - type: "pattern"
    must_match: "(filter ?pred ?input)"
    description: "Filter that can exploit integrity constraints"
  - type: "predicate"
    condition: "has_integrity_constraints(?input)"
    description: "Table must have CHECK, FK, or NOT NULL constraints"
  - type: "capability"
    database: "current"
    requires: "constraint_metadata"
    description: "Database must expose constraint metadata"
```
