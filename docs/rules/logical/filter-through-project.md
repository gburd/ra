# Rule: Filter Pushdown Through Projection

**Category:** logical/predicate-pushdown
**File:** `rules/logical/predicate-pushdown/filter-through-project.rra`

## Metadata

- **ID:** `filter-through-project`
- **Version:** "1.0.0"
...
```yaml
  ...
  - type: "predicate"
    ...
    description: "All filter columns must be available in the input"
  - type: "predicate"
