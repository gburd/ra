# Rule: Starburst Semantic Query Optimization

**Category:** logical/predicate-pushdown
**File:** `rules/logical/predicate-pushdown/starburst-semantic-optimization.rra`

## Metadata

- **ID:** `starburst-semantic-optimization`
- **Version:** "1.0.0"
...
```yaml
  - type: "pattern"
    ...
    description: "Filter amenable to semantic optimization"
  - type: "predicate"
    condition: "has_semantic_knowledge(?input)"
    description: "Schema constraints or domain knowledge available"
  - type: "capability"
    database: "current"
    requires: "constraint_metadata"
    description: "Database must expose integrity constraints"
```
