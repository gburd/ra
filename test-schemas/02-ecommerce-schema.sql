...
-- Insert sample orders (200 orders with realistic distribution)
INSERT INTO orders (customer_id, order_date, total_amount, status, shipping_country) VALUES
    ...
    (4, '2024-02-15', 79.99, 'pending', 'Canada');
...
-- Continue pattern for remaining orders (adding variety)
INSERT INTO order_items (order_id, product_id, quantity, unit_price, discount_percent) VALUES
    (6, 6, 1, 249.99, 0.00),
    (7, 11, 1, 89.99, 0.00),
    (8, 21, 1, 79.99, 0.00),
