-- TPC-DS Query 91: Report call center returns by manager and reason
-- Analyze catalog returns through call centers by manager, marital status,
-- education, and return reason
SELECT
