-- TPC-DS Query 88: Count morning store sales by hourly ranges
-- Report the number of store sales transactions by hour for specific
-- household demographic criteria
SELECT *
FROM (
