-- TPC-DS Query 31
-- Find counties where web sales growth exceeds store sales growth
WITH ss AS (
    SELECT ca_county,
           d_qoy,
           d_year,
...
JOIN ss ss3 ON ss1.ca_county = ss3.ca_county
JOIN ws ws1 ON ss1.ca_county = ws1.ca_county
JOIN ws ws2 ON ss1.ca_county = ws2.ca_county
JOIN ws ws3 ON ss1.ca_county = ws3.ca_county
