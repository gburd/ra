-- TPC-DS Query 77: Compare profit across store, catalog, and web channels
-- Compares sales and profit across store, catalog, and web channels
WITH ss AS (
    SELECT
        s_store_sk,
    ...
    WHERE d_date BETWEEN '2000-08-03' AND (DATE '2000-08-03' + INTERVAL '30 days')
    GROUP BY s_store_sk
),
sr AS (
    SELECT
