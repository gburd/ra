-- TPC-DS Query 90: Ratio of morning to afternoon web sales
-- Calculate the ratio of customers who purchase in the morning vs afternoon
-- on the web, filtered by specific web page types
SELECT
