...
pub enum Token {
    ...
    AtAt,
    /// jsonb @= jsonb -> boolean: DocumentDB/BSON exact match operator
    AtEquals,
    /// jsonb @>= jsonb -> boolean: DocumentDB/BSON greater-than-or-equal comparison
    AtGreaterEquals,
    /// jsonb @<= jsonb -> boolean: DocumentDB/BSON less-than-or-equal comparison
    AtLessEquals,
...
impl fmt::Display for Token {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Token::AtAt => write!(f, "@@"),
            Token::AtEquals => write!(f, "@="),
            Token::AtGreaterEquals => write!(f, "@>="),
            Token::AtLessEquals => write!(f, "@<="),
