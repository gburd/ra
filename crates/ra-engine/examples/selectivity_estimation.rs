...
use ra_core::statistics::{
    ColumnStats, EquiDepthHistogram, Histogram, HistogramBucket,
};
...
fn equality_example() {
    ...
    println!("Estimated selectivity: {:.4} ({:.1}% of rows)",
...
fn range_example() {
    ...
    println!("Default selectivity: {:.4} ({:.1}% of rows)",
        selectivity_default, selectivity_default * 100.0);
    println!("Improvement: {:.1}x more accurate",
...
fn mcv_example() {
    ...
    println!("Estimated selectivity: {:.4} ({:.1}% of rows)",
        selectivity_active, selectivity_active * 100.0);
    ...
    println!("Estimated selectivity: {:.4} (1/NDV fallback)",
        selectivity_rare);
    println!("Improvement over MCV: {:.1}x more accurate for common values",
