...
1,453 `.rra` sources; 279 currently compile to active rewrite rules (regenerate:
...
```
rules/           — 1,453 .rra rule files (logical/, physical/); hardware/, distributed/, multi-model/ moved to ra-lab
